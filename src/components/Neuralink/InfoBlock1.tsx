...
const card1Data = [
  "Estás siglas se refieren a la enfermedad de Esclerosis Lateral Amiotrófica pero se le puede conocer con otros nombres como Enfermedad de Motoneurona o Enfermedad de Lou Gehrig, en honor a un jugador de Béisbol. (una imagen del chango; imagen 1).",
...
const card2Data = [
  "Esta enfermedad provoca la pérdida de neuronas motoras (ver anexo 1) en el sistema nervioso central (SNC) (ver anexo 2), por lo que se afecta la movilidad, más no la sensibilidad por lo que la persona no perderá la vista, olfato, gusto, oído o tacto (y agregas unos iconos).",
